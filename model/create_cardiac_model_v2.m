%% create_cardiac_model_v2.m
% Builds CardiacDigitalTwin_v2.slx programmatically.
%
% The v2 model extends v1 with two physiologically motivated additions:
%
%   1. Hill/Emax receptor binding in HeartRateModel:
%        DrugEffect = Emax * C^n / (EC50^n + C^n)
%      replaces the linear gain. Captures receptor saturation at higher
%      doses (the marginal HR drop shrinks as dose rises).
%
%   2. BaroreflexController as a closed feedback loop:
...
%   - cardiac_params_v2.m has been loaded into base workspace
%
